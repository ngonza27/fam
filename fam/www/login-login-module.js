...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.onSubmit = function (form) {
        ...
        var isAuthenticated = this.authService.logIn(usrName, password);
        isAuthenticated.subscribe(function (value) {
            console.log(value);
            if (value == true) {
                _this.router.navigate(['/energia']);
            }
    ...
    LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _providers_authservice_service__WEBPACK_IMPORTED_MODULE_2__["AuthserviceService"]])
    ], LoginPage);
    return LoginPage;
}());
